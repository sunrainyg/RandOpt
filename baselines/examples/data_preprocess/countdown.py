...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_save_dir', default='~/data/countdown', help='The save directory for the preprocessed dataset.')
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            prompt_messages = make_prefix(example, template_type=args.template_type)
            solution = {
