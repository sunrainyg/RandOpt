...
"""
MATH-500 reward function aligned with RandOpt utils.reward_score.math.
"""
...
def extract_answer(solution_str: str) -> Optional[str]:
    return extract_solution(solution_str, method="strict")
...
def compute_score(solution_str: str, ground_truth: str) -> dict:
    ...
    if pred is None:
        pred = extract_solution(solution_str, method="flexible")
